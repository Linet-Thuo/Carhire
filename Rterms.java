...
public class Rterms extends AppCompatActivity {
    private TextView back;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rterms);

        TextView mTitleWindow = (TextView) findViewById(R.id.textView13);
        TextView mMessageWindow = (TextView) findViewById(R.id.textView19);

        mTitleWindow.setText("Terms and Condition Agreement.");

        mMessageWindow.setText("Terms and conditions of Cartrst ride\n" +
                "\n" +
                ...
                "\n" +
                "We want you to enjoy your ride with Cartrst. We shall do our best to make your ride special and comfortable for you. Nonetheless, we must make clear the limitations in law. " +
        ...
        back = (TextView) findViewById(R.id.textView20);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Rterms.this, Signup.class);
